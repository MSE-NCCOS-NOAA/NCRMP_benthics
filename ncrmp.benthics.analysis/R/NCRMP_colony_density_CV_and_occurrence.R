...
NCRMP_colony_density_CV_and_occurrence <- function(region, ptitle, year, file_path = "NULL", species_filter = "NULL", project = "NULL"){
  ...
  if(region=="FLK" && project == "NCRMP") {
    ...
    region_means <- NCRMP_make_weighted_density_CV_data(region = region,
                                                        sppdens = NCRMP_FLK_2014_24_density_species,
                                                        project = project)
  }
  ...
  if(region=="FLK" && project == "NCRMP_DRM") {
    ...
    region_means <- NCRMP_make_weighted_density_CV_data(region = region,
                                                        sppdens = NCRMP_DRM_FLK_2014_24_density_species,
                                                        project = project)
  }
  ...
  if(region=="Tortugas") {
    ...
    region_means <- NCRMP_make_weighted_density_CV_data(region = region,
                                                        sppdens = NCRMP_Tort_2014_24_density_species,
                                                        project = project)
  }
  ...
  if(region=="SEFCRI" & project == "NCRMP") {
    ...
    region_means <- NCRMP_make_weighted_density_CV_data(region = region,
                                                        sppdens = NCRMP_SEFCRI_2014_24_density_species,
                                                        project = project)
  }
  ...
  if(region=="PRICO") {
    ...
    region_means <- NCRMP_make_weighted_density_CV_data(region = region,
                                                        sppdens = NCRMP_PRICO_2014_25_density_species,
                                                        project = "NCRMP")
  }
  ...
  if(region=="STTSTJ") {
    ...
    region_means <- NCRMP_make_weighted_density_CV_data(region = region,
                                                        sppdens = NCRMP_STTSTJ_2013_25_density_species,
                                                        project = "NCRMP")
  }
  ...
  if(region=="STX") {
    ...
    region_means <- NCRMP_make_weighted_density_CV_data(region = region,
                                                        sppdens = NCRMP_STX_2015_25_density_species,
                                                        project = "NCRMP")
  }
