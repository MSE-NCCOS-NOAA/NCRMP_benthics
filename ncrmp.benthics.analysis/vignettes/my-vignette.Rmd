...
Hardcoral <- NCRMP_STTSTJ_2013_19_wh_cover_region %>%
  dplyr::ungroup() %>%
...
# 
# data("NCRMP_DRM_FLK_2014_18_density_site")
#
# or you can give it a new name 
#
# dat <- NCRMP_DRM_FLK_2014_18_density_site
...
* DRM_SEFCRI_2017_2stage_demo_data - includes data from 2014 - 2017 
* DRM_FLK_2017_2stage_demo_data 
* DRM_Tort_2017_2stage_demo_data 
...
* Examples: 
    * NCRMP_DRM_FLK_2014_18_dis_prev_site, 
    * NCRMP_FGBNMS_2013_18_density_strata,                     
    * NCRMP_FLK_2014_18_rec_mort_region,
    * NCRMP_PRICO_2014_16_richness_strata,
    * NCRMP_STX_2015_17_cover_region
...
* outputs (dataframes):
    ...
    * cover_strata: strata level percent cover of major benthic categories (unweighted)
...
NCRMP_SEFCRI_2014_18_percent_cover_site <- tmp$percent_cover_site
NCRMP_SEFCRI_2014_18_cover_group_key <- tmp$cover_group_key
NCRMP_SEFCRI_2014_18_cover_strata <- tmp$cover_strata
NCRMP_SEFCRI_2014_18_cover_region <- tmp$Domain_est
...
NCRMP_DRM_FLK_2014_18_density_site <- tmp$density_site
NCRMP_DRM_FLK_2014_18_density_strata <- tmp$density_strata
NCRMP_DRM_FLK_2014_18_density_region <- tmp$Domain_est
...
* outputs (dataframes):
    ...
    * richness_strata: strata level species richness (unweighted)
...
NCRMP_Tort_2014_16_richness_strata <- tmp$richness_strata
NCRMP_Tort_2014_16_richness_region <- tmp$Domain_est

NCRMP_Tort_2014_16_diversity_site <- tmp$species_diversity_site
NCRMP_Tort_2014_16_diversity_strata <- tmp$diversity_strata
...
* outputs (dataframes):
    ...
    * density_strata: strata level mortality (unweighted)
...
NCRMP_FGBNMS_2013_15_old_mort_strata <- tmp$old_mortality_strata
NCRMP_FGBNMS_2013_15_rec_mort_strata <- tmp$rec_mortality_strata

NCRMP_FGBNMS_2013_15_old_mort_region <- tmp$Domain_est_old_mort
NCRMP_FGBNMS_2013_15_rec_mort_region <- tmp$Domain_est_rec_mort
...
* outputs (dataframes):
    ...
    * invert_strata: strata level Diadema density (unweighted)
...
NCRMP_PRICO_2014_16_invert_den_strata <- tmp$invert_strata # Right now just Diadema
NCRMP_PRICO_2014_16_invert_den_region <- tmp$Domain_est
...
tmp <- NCRMP_DRM_calculate_disease_prevalence(project = "NCRMP_DRM",
                                        region = "SEFCRI",
                                        species_filter = "FALSE")
...
NCRMP_DRM_SEFCRI_2014_18_dis_prev_site <- tmp$disease_prev_site
NCRMP_DRM_SEFCRI_2014_18_dis_prev_strata <- tmp$dis_prev_strata
NCRMP_DRM_SEFCRI_2014_18_dis_prev_region <- tmp$Domain_est
