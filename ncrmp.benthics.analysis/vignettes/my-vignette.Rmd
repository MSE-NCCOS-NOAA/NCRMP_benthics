...
* Florida:  
    ...
    * Dry Tortugas (Tortugas; 2014, 2016) 
...
* Gulf of Mexico:
    * Flower Garden Banks National Marine Sanctuary (GOM; 2013, 2015)
    
Upcoming data additions: Florida & Gulf of Mexico 2018 (in 2019), Caribbean 2019 (in 2020)
...
* NTOT files:
    ...
    * FL_2016_NTOT (SEFCRI, FLK & Tortugas)
    * PRICO_2016_NTOT
    * FGBNMS_2015_NTOT
...
* parameters:
    ...
    * year: 2013, 2014, 2015, 2016, 2017 Note - for each region, only years where sampling was conducted will run
...
### 4. NCRMP_FRRP_calculate_colony_density
...
# Run function 
tmp <- NCRMP_FRRP_calculate_colony_density(project = "NCRMP_FRRP", 
                                           region = "FLK",
...
This function is called within NCRMP_FRRP_calculate_colony_density so the initial parameters you provide for region and year will be passed on. 
...
### 7. NCRMP_FRRP_calculate_species_richness_diversity
...
### 8. NCRMP_FRRP_calculate_mortality
...
# Run function
tmp <- NCRMP_FRRP_calculate_mortality(project = "NCRMP",
                                      region = "GOM",
                                      species_filter = "TRUE",
...
### 10. NCRMP_FRRP_calculate_disease_prevalence
...
tmp <- NCRMP_FRRP_calculate_disease_prevalence(project = "NCRMP_FRRP",
                                        region = "SEFCRI",
                                        species_filter = "FALSE")
...
### 1. What species are used when you filter the species in NCRMP_FRRP_calculate_colony_density, NCRMP_FRRP_calculate_disease_prevalence or NCRMP_FRRP_calculate_mortality?

__First 6 species are from sample allocation, remainder are ESA listed species__


* FLK_filter <- c("COL NATA", "MON CAVE", "ORB FAVE", "POR PORI", "SID SIDE", "SOL BOUR", "ACR CERV", "ACR PALM", "ORB ANNU", "ORB FRAN", "DEN CYLI", "MYC FERO")
...
__First 5 species are from sample allocation, remainder are ESA listed species__
...
__Top 10 most abundant species - minus POR ASTR__
