...
* Florida:  
    * Southeast Florida (SEFCRI; 2014, 2016, 2018)
    * Florida Keys (FLK; 2014, 2016, 2018)
    * Dry Tortugas (Tortugas; 2014, 2016, 2018) 

* Caribbean:
    * St. Thomas & St. John (STTSTJ; 2013, 2015, 2017, 2019)
    * St. Croix (STX; 2015, 2017, 2019)
    * Puerto Rico (PRICO; 2014, 2016)

* Gulf of Mexico:
    * Flower Garden Banks National Marine Sanctuary (GOM; 2013, 2015, 2018)
    
Upcoming data additions: Puerto Rico 2019 (in 2020), Florida and GOM 2020 (in 2021)
...
* Examples: 
    ...
    * NCRMP_FGBNMS_2013_18_unwh_density_strata,                     
    * NCRMP_FLK_2014_18_wh_rec_mort_region,
    * NCRMP_PRICO_2014_16_unwh_richness_strata,
    * NCRMP_STX_2015_19_wh_cover_region
...
* Sampling grids:
    ...
    * STTSTJ_2019_sample_frame_WGS1984
    * STX_2019_sample_frame_WGS1984
...
### 3. NCRMP_DRM_calculate_colony_density
...
NCRMP_DRM_FLK_2014_18_wh_density_region <- tmp$Domain_est
...
### 6. NCRMP_DRM_calculate_species_richness_diversity
...
NCRMP_Tort_2014_18_unwh_richness_strata <- tmp$richness_strata
NCRMP_Tort_2014_18_wh_richness_region <- tmp$Domain_est
...
NCRMP_FGBNMS_2013_18_rec_mort_site <- tmp$recent_mortality_site

NCRMP_FGBNMS_2013_18_old_mort_strata <- tmp$old_mortality_strata
NCRMP_FGBNMS_2013_18_rec_mort_strata <- tmp$rec_mortality_strata

NCRMP_FGBNMS_2013_18_wh_old_mort_region <- tmp$Domain_est_old_mort
NCRMP_FGBNMS_2013_18_wh_rec_mort_region <- tmp$Domain_est_rec_mort
...
NCRMP_DRM_SEFCRI_2014_18_unwh_dis_prev_strata <- tmp$unwh_dis_prev_strata
NCRMP_DRM_SEFCRI_2014_18_wh_dis_prev_region <- tmp$Domain_est
...
# NCRMP species filter were developed in status report meetings and are region specific, please see the functions listed above for each list. 
