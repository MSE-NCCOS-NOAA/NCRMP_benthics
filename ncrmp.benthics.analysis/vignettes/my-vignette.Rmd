...
* FRRP_SEFCRI_2017_2stage_demo_data 
...
If you would like to run your own data, apply present species filters to certain functions or just know more about how NCRMP metrics are calculated, please feel free to use these functions or check out the code. Comments or suggestions on how to approve the package are welcome. 
...
__Calculates disease prevalence at the site (% colonies per site), strata (% colonies per strata), and regional (% colonies per region) level for all sampling years__
